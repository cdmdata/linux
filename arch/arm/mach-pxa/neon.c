/*
 *  linux/arch/arm/mach-pxa/neon.c
 *
 *  Support for the Boundary Devices Neon board, a PXA255-based
 *  system with Silicon-Motion SM-501 graphics processor.
 *
 *  Author:	Eric Nelson
 *  Created:	May 12, 2007
