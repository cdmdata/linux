...
#define MX53_I2C1_PAD_CTRL	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
			PAD_CTL_PUS_22K_UP | PAD_CTL_ODE | PAD_CTL_DSE_HIGH | PAD_CTL_SRE_FAST)
...
#define MX53_PAD_KEY_COL1__FEC_RX_CLK		IOMUX_PAD(0x354, 0x2C, 6, 0x808, 0, PAD_CTRL_8)
#define MX53_PAD_KEY_ROW1__GPIO_4_9		IOMUX_PAD(0x358, 0x30, 1, 0x0, 0, NO_PAD_CTRL)
#define MX53_PAD_KEY_ROW1__FEC_COL		IOMUX_PAD(0x358, 0x30, 6, 0x800, 0, PAD_CTRL_8)
...
#define MX53_PAD_KEY_COL3__FEC_CRS		IOMUX_PAD(0x364, 0x3C, 6, 0x0, 0, PAD_CTRL_8)
...
#define MX53_PAD_EIM_D30__UART3_CTS		IOMUX_PAD(0x49C, 0x154, 2, 0x0, 0, MX53_UART_PAD_CTRL)
...
#define MX53_PAD_GPIO_6__I2C3_SDA	IOMUX_PAD(0x6B4, 0x324, 2 | IOMUX_CONFIG_SION, 0x828, 1, PAD_CTRL_9)
...
#define MX53_PAD_NANDF_CS2__CSI0_MCLK	IOMUX_PAD(0x5B8, 0x240, 5, 0x0, 0, NO_PAD_CTRL)
...
/* AUD4 */
#define MX53_PAD_SD2_CLK__AUD4_RXFS		IOMUX_PAD(0x688, 0x2FC, 3, 0x73c, 1, NO_PAD_CTRL)
#define MX53_PAD_SD2_CMD__AUD4_RXC		IOMUX_PAD(0x68C, 0x300, 3, 0x738, 1, NO_PAD_CTRL)
...
#define MX53_PAD_EIM_D30__UART3_CTS		IOMUX_PAD(0x49C, 0x154, 4, 0, 0, MX53_UART_PAD_CTRL)
#define MX53_PAD_EIM_D31__UART3_RTS		IOMUX_PAD(0x4A0, 0x158, 4, 0, 0, MX53_UART_PAD_CTRL)
...
#define MX53_PAD_EIM_CS1_CSPI2_MOSI	IOMUX_PAD(0x4D0, 0x184, 2, 0x7C0, \
					2, NO_PAD_CTRL)
#define MX53_PAD_EIM_OE_CSPI2_MISO	IOMUX_PAD(0x4D4, 0x188, 2, 0x7BC, \
					2, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_22K_UP)
#define MX53_PAD_EIM_LBA_CSPI2_CS2      IOMUX_PAD(0x4DC, 0x190, 2, 0x7C8, \
					1, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
#define MX53_PAD_EIM_CS0_CSPI2_SCLK     IOMUX_PAD(0x4CC, 0x180, 2, 0x7B8, \
					2, NO_PAD_CTRL)
