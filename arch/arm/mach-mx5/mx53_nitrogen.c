...
static struct plat_i2c_bq2416x_data i2c_bq2416x_data = {
	...
	.policy = {
		...
		.charge_current_limit_mA = 2500,	/* 550mA - 2875mA, default 1000mA */
		.terminate_current_mA = 25,		/* 50mA - 400mA, default 150mA, Stop charging when current drops to this */
		.usb_voltage_limit_mV = 4200,		/* 4200mV - 47600mV, default 4200mV, reduce charge current to stay above this */
		.usb_current_limit_mA = 1000,		/* 100mA - 1500mA, default 100mA */
		...
		.charge_timeout_minutes = 9*60,		/* 27 minute, 6 hours, 9 hours, infinite are choices, default 27 minutes */
		.otg_lock = 0,
