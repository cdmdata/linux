 ...
 */
#ifndef _DAVINCIFB_REGS_H_
#define _DAVINCIFB_REGS_H_
...
#define RSZ_PID			(RSZ_REG_BASE + 0x00)	//read-only
#define RSZ_PCR			(RSZ_REG_BASE + 0x04)	//shadowed
#define RSZ_RSZ_CNT		(RSZ_REG_BASE + 0x08)	//busy-lock
#define RSZ_OUT_SIZE		(RSZ_REG_BASE + 0x0c)	//busy-lock
#define RSZ_IN_START		(RSZ_REG_BASE + 0x10)	//busy-lock
#define RSZ_IN_SIZE		(RSZ_REG_BASE + 0x14)	//busy-lock
#define RSZ_SDR_INADD		(RSZ_REG_BASE + 0x18)	//shadowed
#define RSZ_SDR_INOFF		(RSZ_REG_BASE + 0x1c)	//shadowed
#define RSZ_SDR_OUTADD		(RSZ_REG_BASE + 0x20)	//shadowed
#define RSZ_SDR_OUTOFF		(RSZ_REG_BASE + 0x24)	//shadowed
#define RSZ_HFILT		(RSZ_REG_BASE + 0x28)	//busy-lock
#define RSZ_VFILT		(RSZ_REG_BASE + 0x68)	//busy-lock
#define RSZ_YENH		(RSZ_REG_BASE + 0xA8)	//busy-lock
...
#define OSD_OSDATRMD_OASW_SHIFT			15
...
#define OSD_RECTCUR_CLUTSR			(1 << OSD_RECTCUR_CLUTSR_SHIFT)
